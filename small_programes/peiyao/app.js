  ...
  onlogin() {
    ...
    wx.login({
      success: function (res) {
        if (res.code) {
          wx.request({
            url: 'https://www.nonghuobang.cn/miniapp/helper/wxa64c9cda17213d26/index?code=' + res.code,
            success: function (res) {
              console.log(res)
                ...
                if (res.data.data.id) {
                  ...
                  wx.getUserInfo({
                    success(res) {
                      ...
                      wx.request({
                        url: 'https://www.nonghuobang.cn/miniapp/helper/wxa64c9cda17213d26/userInfo',
                        data: {
