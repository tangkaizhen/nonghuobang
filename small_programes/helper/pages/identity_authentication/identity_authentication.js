...
Page({
  ...
  data: {
    ...
    z_img:'/images/pic_IDcard_z.png',
    z_res:'',
    f_img:'/images/pic_IDcard_f.png',
    f_res:''
  },
  ...
  submit(){
    var that=this
    if (this.data.z_img =='/images/pic_IDcard_z.png'){
      util.showInfo("请选择身份证正面")
      return
    }
    if (this.data.f_img =='/images/pic_IDcard_f.png'){
      util.showInfo("请选择身份证反面")
      return
    }
    wx.request({
            ...
            data: {
              ...
              idCardPic1: that.data.z_res,
              idCardPic2: that.data.f_res
            },
