        ...
        .then(res => {
          ...
          wx.request({
            ...
            data: {
              ...
              province: recevie_order_position_obj.province,
              city: recevie_order_position_obj.city,
              district: recevie_order_position_obj.district,
              street: recevie_order_position_obj.street,
              address: recevie_order_position_obj.address,
              longitude: recevie_order_position_obj.longitude,
              latitude: recevie_order_position_obj.latitude
            },
            header: wx.getStorageSync('header'),
            success(res) {
              if (res.data.status == 1) {
