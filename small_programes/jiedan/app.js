  ...
  onlogin() {
    ...
    wx.login({
      success: function (res) {
        if (res.code) {
          wx.request({
            url: 'https://www.nonghuobang.cn/miniapp/helper/wx26509205fe07860e/index?code=' + res.code,
            success: function (res) {
              console.log(res)
                ...
                if (res.data.data.id) {
                  ...
                  wx.getUserInfo({
                    success(res) {
                      ...
                      wx.request({
                        url: 'https://www.nonghuobang.cn/miniapp/helper/wx26509205fe07860e/userInfo',
                        data: {
